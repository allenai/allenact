...
class ObjectNavHabitatRGBDeterministicSimpleConvGRUPPOExperimentConfig(ObjectNavHabitatBaseExperimentConfig):
    ...
    CONFIG.SIMULATOR.DEPTH_SENSOR.WIDTH = 1
    CONFIG.SIMULATOR.DEPTH_SENSOR.HEIGHT = 1
    CONFIG.SIMULATOR.DEPTH_SENSOR.POSITION = [0, 0.88, 0]
    CONFIG.SIMULATOR.SEMANTIC_SENSOR.WIDTH = 1
    CONFIG.SIMULATOR.SEMANTIC_SENSOR.HEIGHT = 1
    CONFIG.SIMULATOR.SEMANTIC_SENSOR.POSITION = [0, 0.88, 0]
