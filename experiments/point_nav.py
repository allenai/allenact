...
class PointNavHabitatGibsonExperimentConfig(ExperimentConfig):
    ...
    TRAIN_SCENES = "/Users/klemenk/Code/nav-ablation/habitat-api/data/datasets/pointnav/habitat-test-scenes/v1/train/train.json.gz"
    VALID_SCENES = "/Users/klemenk/Code/nav-ablation/habitat-api/data/datasets/pointnav/habitat-test-scenes/v1/val/val.json.gz"
    TEST_SCENES = "/Users/klemenk/Code/nav-ablation/habitat-api/data/datasets/pointnav/habitat-test-scenes/v1/test/test.json.gz"
    ...
    CONFIG.defrost()
    CONFIG.DATASET.SCENES_DIR = '/Users/klemenk/Code/nav-ablation/habitat-api/data/scene_datasets/'
