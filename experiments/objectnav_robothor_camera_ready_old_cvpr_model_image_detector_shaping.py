...
from models.frcnn_tensor_object_nav_models import ResnetFasterRCNNTensorsObjectNavActorCriticCVPR2020
...
class ObjectNavRoboThorImageDetectorExperimentConfig(ExperimentConfig):
    ...
    CAMERA_WIDTH = 448  # 640
    CAMERA_HEIGHT = 448  # 480
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return ResnetFasterRCNNTensorsObjectNavActorCriticCVPR2020(
