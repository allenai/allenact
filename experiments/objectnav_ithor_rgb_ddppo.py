...
class ObjectNaviThorRGBPPOExperimentConfig(ExperimentConfig):
    ...
    def train_task_sampler_args(
        ...
        res = self._get_sampler_args_for_scene_split(
            "dataset/ithor/objectnav/train/episodes",
            process_ind,
            total_processes,
            seeds=seeds,
            deterministic_cudnn=deterministic_cudnn,
        )
        res["scene_directory"] = "dataset/ithor/objectnav/train"
    ...
    def valid_task_sampler_args(
        ...
        res = self._get_sampler_args_for_scene_split(
            "dataset/ithor/objectnav/val/episodes",
            process_ind,
            total_processes,
            seeds=seeds,
            deterministic_cudnn=deterministic_cudnn,
        )
        res["scene_directory"] = "dataset/ithor/objectnav/val"
