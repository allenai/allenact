...
from models.tensor_object_nav_models import ResnetTensorObjectNavActorCriticCVPR2020
...
class ObjectNavRoboThorImageDetectorExperimentConfig(ExperimentConfig):
    ...
    NUM_PROCESSES = 25  # TODO 2 for debugging
    ...
    ENV_ARGS = dict(
        width=300,  # SCREEN_SIZE,
        height=300,  # SCREEN_SIZE,
        continuousMode=True,
    ...
    @classmethod
    def tag(cls):
        return "ObjectNavCVPR2020ImageOnlyNoshaping"
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return ResnetTensorObjectNavActorCriticCVPR2020(
    ...
    def _get_sampler_args_for_scene_split(
        ...
        return {
            ...
            "rewards_config": {
                ...
                "delta_dist_reward_closer": 1.0,
                "delta_dist_reward_same": 0.0,
                "delta_dist_reward_further": -1.0,
            },
        }
