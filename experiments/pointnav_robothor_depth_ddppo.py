...
class PointNavRoboThorDepthDDPPOExperimentConfig(ExperimentConfig):
    ...
    SCREEN_SIZE = 256
    MAX_STEPS = 500
    ADVANCE_SCENE_ROLLOUT_PERIOD = 100000000000000000000000000  # if more than 1 scene per sampler

    VALIDATION_SAMPLES_PER_SCENE = 1

    NUM_PROCESSES = 60  # 1 scene per sampler
    ...
    @classmethod
    def tag(cls):
        return "PointNavRoboThorDepthDDPPO"
