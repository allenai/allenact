# plugins.robothor_plugin.robothor_preprocessors [[source]](https://github.com/allenai/embodied-rl/tree/master/plugins/robothor_plugin/robothor_preprocessors.py)
