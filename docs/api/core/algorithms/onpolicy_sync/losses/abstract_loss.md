# core.algorithms.onpolicy_sync.losses.abstract_loss [[source]](https://github.com/allenai/allenact/tree/master/core/algorithms/onpolicy_sync/losses/abstract_loss.py)
