...
And the `mp4` results can be seen in the image tab of Tensorboard while testing.

![gif demo](https://ai2-prior-allenact-public-assets.s3.us-west-2.amazonaws.com/tutorials/gym-mujoco/ant_test.mp4)
