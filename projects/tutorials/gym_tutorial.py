...
After 1,500,000 steps, the script will terminate. If everything went well, the `valid` success rate should quickly
...
```bash
python main.py gym_tutorial -b projects/tutorials -m 1 -o /PATH/TO/gym_output -s 54321 -e -t EXPERIMENT_DATE -k 2
```
