...
class ObjectNavMixInResNet50GRUConfig(ObjectNavBaseConfig):
    @classmethod
        ...
        if rgb_sensor is not None:
            preprocessors.append(
                ResNetPreprocessor(
                    ...
                    output_uuid="rgb_resnet50_imagenet",
                )
            )
        ...
        if depth_sensor is not None:
            preprocessors.append(
                ResNetPreprocessor(
                    ...
                    output_uuid="depth_resnet50_imagenet",
                )
            )
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        ...
        return ResnetTensorObjectNavActorCritic(
            ...
            rgb_resnet_preprocessor_uuid="rgb_resnet50_imagenet" if has_rgb else None,
            depth_resnet_preprocessor_uuid="depth_resnet50_imagenet"
            if has_depth
            else None,
            hidden_size=512,
            goal_dims=32,
