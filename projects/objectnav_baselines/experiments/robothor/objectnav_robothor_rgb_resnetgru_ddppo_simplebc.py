...
class ObjectNaviThorRGBPPOAndSimpleBCExperimentConfig(ObjectNavRoboThorBaseConfig):
    ...
    def __init__(self):
        ...
        self.REWARD_CONFIG["failed_stop_reward"] = -1.0
        self.REWARD_CONFIG["positive_only_reward"] = True
        self.REWARD_CONFIG["shaping_weight"] = 4.0
    ...
    @classmethod
    def tag(cls):
        return "Objectnav-RoboTHOR-RGB-ResNetGRU-DDPPO-SimpleBC"
    ...
    def training_pipeline(self, **kwargs):
        ...
        return TrainingPipeline(
            ...
            num_steps=num_steps,
            named_losses={"ppo_loss": PPO(**PPOConfig), "imitation_loss": Imitation()},
            gamma=gamma,
            use_gae=use_gae,
