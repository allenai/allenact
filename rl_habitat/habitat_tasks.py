...
class PointNavTask(Task[HabitatTask]):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.last_geodesic_distance = self.env.env.get_metrics()['distance_to_goal']['distance_to_goal']
        self._rewards = []
    ...
    def judge(self) -> float:
        ...
        geodesic_distance = self.env.env.get_metrics()['distance_to_goal']['distance_to_goal']  # self.env.get_geodesic_distance()
